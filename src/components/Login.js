...
const Login = () => {
	...
	return (
		<>
			...
			<form className="  my-36 mx-auto right-0 left-0  w-3/12 absolute bg-black  text-white bg-opacity-80 rounded-lg">
				...
				<input
					...
					className="mx-10 p-3  my-3 w-4/5 bg-gray-600 bg-opacity-40 rounded-lg"
				/>
				<button className="mx-10 p-2 my-2 bg-red-600 w-4/5 rounded-lg text-lg ">
					{isSign ? "Sign In" : "Sign Up"}
				</button>
